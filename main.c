  ...
  do {
    ...
    switch (choice) {
        case 1: {
            ...
            //searches for a space if there is it breaks the case, since emails cannot have spaces.
            ...
            //checks for an @ symbol if there isnt it breaks the case, since emails must have an @ symbol
            //this needs to be after the space search as it copys to the actual email instead of a tmp variable
        ...
        case 5: {
            ...
            switch (choice) {
                case 'Y':
                case 'y': {
                    printf("You will NOT be able to recover any data, are you sure you want to DELETE CONTACT DATA? (Y/N): ");
                    scanf(" %c", &choice);
